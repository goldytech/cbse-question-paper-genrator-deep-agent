...
NOTE: This entire module is disabled pending Qdrant vector database integration.
All Tavily-based search functionality has been commented out below.
"""

# =============================================================================
# TAVILY-BASED CURRICULUM SEARCH - DISABLED
# =============================================================================
# This module previously provided curriculum search functionality using Tavily.
# It has been disabled and will be replaced with Qdrant vector database search.
#
# To re-enable:
# 1. Uncomment the imports
# 2. Uncomment the _tavily_client initialization
# 3. Uncomment the _get_tavily_client() function
# 4. Uncomment the @tool decorated function
# 5. Update src/config/agent_config.py to include this tool
#
# import os
